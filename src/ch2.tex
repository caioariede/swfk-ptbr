...
\section{Não é igual a uma lista de compras}\index{lists}
...
\subsection*{\color{BrickRed}Substituindo itens}\index{lists!replacing}
...
\subsection*{\color{BrickRed}Adicionando itens...}\index{lists!appending}
...
\subsection*{\color{BrickRed}$\ldots$e removendo itens}\index{lists!removing}
...
\subsection*{\color{BrickRed}Duas listas é melhor que apenas 1}\index{lists!joining}
...
\section{Tuplas e Listas}\label{tuplesandlists}\index{tuples}
