...
Imprimirá `olá' 9 vezes (cada vez adicionando 1 à variável \code{x}, até que \code{x} não mais seja menor que 10). Esta forma é obviamente um pouco parecido com o laço `for', mas tem suas utilidades em algumas situações.
