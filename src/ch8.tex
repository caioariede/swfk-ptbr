...
\chapter{Mais e mais tartarugas}\index{Tartaruga!Avançado}\label{ch:turtlesgalore}
...
No código acima, nós verificamos se a variável \code{x} contém um número par. Para fazer isso, nós usamos um operador chamado módulo (\%)\index{Operador `%'}, na expressão: \code{x \% 2 == 0}.
\par
...
A função \code{color}\index{Tartaura!Função `color'}, aceita 3 parâmetros. O primeiro parâmetro é o valor para o vermelho, o segundo é o valor para o verde e o último é o valor para o azul.
\par
...
\section{Escuridão}\index{Tartaruga!Função `color'!black}
...
\section{Preenchendo coisas}\index{Tartaruga!Função `fill'}
...
\end{center}
\caption{Uma estrela contornada.}\label{fig30}
\end{figure}

\section{Coisas para tentar}

\emph{Neste capítulo, nós aprendemos sobre o módulo `turtle', usando-o para desenhar algumas formas geométricas básicas. Nós usamos funções, para podermos reutilizar os nossos códigos e facilitar na hora de desenhar formas com diferentes cores.}

\subsection*{Exercício 1}
Nós desenhamos estrelas, quadrados e retângulos. Que tal um octógono? Um octógono tem 8 lados.
(Dica: tente virando 45 graus).

\subsection*{Exercício 2}
Agora, converta o código que desenha um octógono em uma função, que o preencherá com uma cor.
