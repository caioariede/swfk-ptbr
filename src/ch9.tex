...
\end{center}
\caption{Um simples círculo.}\label{fig40}
\end{figure}
...
\end{center}
\caption{Um simples triângulo.}\label{fig41}
\end{figure}

Nós podemos adicionar um polígono irregular, usando o seguinte código: A figura~\ref{fig42} exibe o triângulo e o polígulo de forma irregular.
