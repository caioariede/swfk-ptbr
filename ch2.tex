...
Ovos, leite, queijo, salsinha e margarina. Que não é uma lista de compras completa, mas serve para o que precisamos. Se você quiser armazenar isso em uma variável, você pode criar uma string:
